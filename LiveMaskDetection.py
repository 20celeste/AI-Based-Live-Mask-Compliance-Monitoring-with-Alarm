...
CUSTOM_MODEL_PATH = r"C:\Image\Livemask detect project\best(mask).pt" # Your trained model
ALARM_SOUND_PATH = r"C:\Image\Livemask detect project\Answering Machine Beep-SoundBible.com-1804176620.mp3"  # Your alert sound
